...
# https://github.com/carlalexander/passwords-evolved/blob/master/.circleci/deploy-plugin.sh
...
PLUGIN_BUILD_DIRECTORIES=(assets i18n vendor Wprightontime)
PLUGIN_BUILD_FILES=(index.php LICENSE readme.txt uninstall.php wprightontime.php)
